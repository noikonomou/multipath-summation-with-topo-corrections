...
1. The function "topomig2d_varV", which can be downloaded from https://github.com/tinawunderlich/MultichannelGPR, under the GNU 3.0 licence and
2. The package "hyperbola recognition", which can be downloaded from https://github.com/lweileeds/hyperbola_recognition.
