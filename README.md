...
For the implementation of multi-path summation we use the package "hyperbola recognition", which can be downloaded from https://github.com/lweileeds/hyperbola_recognition.
