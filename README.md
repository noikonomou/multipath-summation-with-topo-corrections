...
The former is used to automatically detect hyperbolas within the GPR section. The hyperbolas are used for GPR velocities estimation which in their turn are invlolved in a multipath summation scheme. The latter is used to apply topographic corrections.
